    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="bg-faded p-4 my-4">
                ...
                <h2>Brugeren ID  <%=request.getAttribute("customerID")%> konto oplysninger</h2>
                ...
                <form  name="Admin_UserAdministration" action="FrontController" method="POST">
                    ...
                    <button type="submit" name="Admin_UserAdministration" value="Submit">Implementere bruger ændringer </button>
